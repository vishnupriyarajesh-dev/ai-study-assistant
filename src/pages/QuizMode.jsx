...
export default function QuizMode() {
  ...
  const handleStart = () => {
    ...
    setStarted(true);
    const newMessages = [{ role: "user", content: `Quiz me on: ${input}` }];
    setMessages(newMessages);
    setInput("");
    sendMessage(newMessages, PROMPTS.quiz);
  };
    ...
    <div style={{ maxWidth: "800px", margin: "0 auto", display: "flex", flexDirection: "column", height: "90vh" }} className="fade-in">
      ...
      <div style={{
        ...
        {!started && (
          <div className="fade-in" style={{
            ...
            <p>Enter a topic below and I'll start quizzing you.</p>
          </div>
        )}
      ...
      <div style={{
        ...
        <textarea
          ...
          placeholder={started ? "Type your answer... (Enter to submit)" : "Enter a topic to get quizzed on..."}
          rows={1}
        ...
        >
          {isLoading ? "..." : started ? "Answer" : "Start Quiz"}
        </button>
      </div>
    </div>
  );
